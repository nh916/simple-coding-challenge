...
user can search an artist by using keywords. 
Then if the user clicks on the Artist, 
it will display It’s album list 
    plus any other information you want to show.
